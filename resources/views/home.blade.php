                                    ...
                                    <tbody>
                                        @foreach($bajoStock as $farmaco)
                                            @php
                                                ...
                                                $porcentaje = $stockMinimo > 0 ? round(($stockActual / $stockMinimo) * 100) : 0;
                                            @endphp
                                            <tr>
                                                ...
                                                <td class="text-center small">{{ $farmaco->getStockMinimoCalculado() }}</td>
                                                <td class="text-center">
                        ...
                        @if($mayorStock->count() > 0)
                            @foreach($mayorStock as $farmaco)
                                @php
                                    ...
                                    $stockMinimo = $farmaco->getStockMinimoCalculado();
                                    $porcentaje = $stockMinimo > 0 ? round(($stockCalc / $stockMinimo) * 100) : 0;
                                @endphp
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">{{ $porcentaje }}% del máximo ({{ $farmaco->getStockMinimoCalculado() }})</small>
                                </div>
                            @endforeach
                        @else

<div class="modal fade py-3" id="edit-farmaco" tabindex="-1" role="dialog" aria-labelledby="editFarmacoModalLabel" aria-hidden="true">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Al hacer click en el botón de editar farmaco
        document.querySelectorAll('.edit-farmaco-btn').forEach(function(btn) {
                        ...
                        <form action="/farmacos/${farmacoId}" method="POST">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control form-control-sm" value="${farmaco.fecha_vencimiento}">
                                    </div>
